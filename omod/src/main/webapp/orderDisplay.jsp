...
<tr class="tr_${counter}">
   ...
   <td><a href="${pageContext.request.contextPath}/module/pharmacymanagement/stocksecurity.list?drugId=${consommation.value.drugProduct.drugId.drugId}&locationId=${consommation.value.location.locationId}">${consommation.value.drugProduct.drugId.name}</a></td>
    <td>${consommation.value.drug.units}&nbsp;</td>
...
<tr>
   ...
   <td><a href="${pageContext.request.contextPath}/module/pharmacymanagement/stocksecurity.list?conceptId=${consommation.value.drugProduct.conceptId.conceptId}&locationId=${consommation.value.location.locationId}">${consommation.value.drugProduct.conceptId.name.name}</a></td>
    <td>&nbsp;</td>
    <td class="simple">${consommation.value.qntPremJour}&nbsp;</td>
   <td class="simpleSpan">${consommation.value.qntRecuMens}&nbsp;</td>
   <td class="simple">${consommation.value.qntConsomMens}&nbsp;</td>
