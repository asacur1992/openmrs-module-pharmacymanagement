...
public interface DrugOrderService {
	...
	/**
	 * get a product by passing the product id
	 * 
	 * @parameter productId
	 */
	...
	public Collection<DrugProductInventory> getDrugInventoryByDrugId(
			String drugId, String conceptId, String locationId, String pharmacyId);
	...
	/**
	 * get the current solde of a particular dispensed drug in the internal pharmacy level
	 * 
	 * @return current solde
	 */
	...
	/**
	 * returns Collection<<code>PharmacyInventory</code>> by <code>Date</code>
	...
	/**
	 * returns a collection of <code>DrugProduct</code> by passing the date from
	 * up to and the location
	 * 
	 * @param from
	 * @param to
	 * @param locationId
	...
	/**
	 * Returns the drug being consumed by a patient appointed on the next visit
	 * <code>Obs</code>
	 * 
	 ...
	 * <code>DrugProduct</code>> that  remainder is 2 month to expiry
	 * 
	...
	/**
	 * returns the sum of sortie and entree by passing the date, drug and the
	 * location
	 */
	...
	/**
	 * returns the quantity of the denspensed and received drug during the week
	 * reported
	 * 
	 * @param from
	 * @param to
	...
	/**
	 * returns a <code>java.util.List</code> of <code>ProductReturnStore</code>
	 * 
	 * @param arsId
	 ...
	 * @return
	 */
	public void saveOrUpdateConsumableDispense(ConsumableDispense consumableDipsense);
